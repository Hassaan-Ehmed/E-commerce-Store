...
export default function Login() {
  ...
  const addUser=(e)=>{
    ...
    let userInfo = { userEmail : email, userPassword : password }
...
<tr className='mt-5  flex justify-end items-center '><button className='bg-[#E52F06] py-[10px] px-[20px] rounded-3xl text-white text-md shadow-[0px_9px_8px_-6px_#333333] active:shadow-none active:delay-75' onClick={addUser} >Log In</button></tr>
